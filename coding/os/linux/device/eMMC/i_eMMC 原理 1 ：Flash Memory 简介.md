...
1. [Wiki: Common Flash Memory Interface](https://en.wikipedia.org/wiki/Common_Flash_Memory_Interface) \[Web\]
1. [Quick Guide to Common Flash Interface](https://www.spansion.com/Support/Application%20Notes/Quick_Guide_to_CFI_AN.pdf) \[PDF\]
1. [MICRON NOR Flash Technology](https://www.micron.com/products/nor-flash) \[Web\]
1. [MICRON NAND Flash Technology](https://www.micron.com/products/nand-flash) \[Web\]
1. [Wiki：闪存](https://zh.wikipedia.org/wiki/%E9%97%AA%E5%AD%98) \[Web\]
1. [Wiki：Flash File System](https://en.wikipedia.org/wiki/Flash_file_system) \[Web\]
1. [Wear Leveling in Micron® NAND Flash Memory](https://www.micron.com/~/media/documents/products/technical-note/nand-flash/tn2961_wear_leveling_in_nand.pdf) \[PDF\]
1. [Understanding Flash: The Flash Translation Layer](https://flashdba.com/2014/09/17/understanding-flash-the-flash-translation-layer/) \[Web\]
1. [谈NAND Flash的底层结构和解析](http://blog.sina.com.cn/s/blog_4b4b54da01016rx3.html) \[Web\]
1. [闪存基础](http://www.ssdfans.com/?p=45) \[Web\]
1. [Open NAND Flash Interface (ONFI)](http://www.onfi.org/) \[Web\]
