...
2: extern int \_\_must_check bus_register(struct bus_type \*bus);
...
1. /\*\*
1. - struct subsys_interface - interfaces to device functions
1. - @name:       name of the device function
1. - @subsys:     subsytem of the devices to attach to
1. - @node:       the list of functions registered at the subsystem
1. - @add_dev:    device hookup to device function handler
1. - @remove_dev: device hookup to device function handler
1. -
1. - Simple interfaces attached to a subsystem. Multiple interfaces can
1. - attach to a subsystem and its devices. Unlike drivers, they do not
1. - exclusively claim or control devices. Interfaces usually represent
1. - a specific functionality of a subsystem/class of devices.
1. \*/
