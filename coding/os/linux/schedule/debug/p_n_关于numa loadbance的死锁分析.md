...
在 26号cpu的调用链中，stop_two_cpus-->cpu_stop_queue_two_works-->\_\_cpu_stop_queue_work 函数

由于 cpu_stop_queue_two_works 被内联了，但是 cpu_stop_queue_two_works 调用 \_\_cpu_stop_queue_work
...
说明压栈的是244行的地址，也就是说目前调用的是243行的 \_\_cpu_stop_queue_work。
