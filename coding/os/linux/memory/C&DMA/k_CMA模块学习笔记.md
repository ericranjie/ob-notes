...
![[Pasted image 20241019092009.png]]
...
> setup_arch--->arm64_memblock_init--->early_init_fdt_scan_reserved_mem--->\_\_fdt_scan_reserved_mem--->memblock_reserve

完成上面的初始化之后，memblock模块已经通过device tree构建了整个系统的内存全貌：哪些是普通内存区域，哪些是保留内存区域。对于那些reserved memory，我们还需要进行初始化，代码如下：

> setup_arch--->arm64_memblock_init--->early_init_fdt_scan_reserved_mem--->fdt_init_reserved_mem--->\_\_reserved_mem_init_node
...
> start_kernel--->mm_init--->mem_init--->free_all_bootmem--->free_low_memory_core_early--->\_\_free_memory_core
...
> static int \_\_init cma_activate_area(struct cma \*cma)\
> {\
