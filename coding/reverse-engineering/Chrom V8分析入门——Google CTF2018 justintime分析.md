...
2. [Pwn](https://bbs.kanxue.com/forum-171.htm)
...
2. `node —allow-natives-syntax` 执行脚本
    ...
    2. 由于无限循环语句，进程挂起；
3. 通过`ps -a | grep node`的方式找到该进程的PID；
4. 使用`gdb attach [pid]`或者其他调试器附加到该进程，开始调试。
...
2. [Introduction to TurboFan](https://doar-e.github.io/blog/2019/01/28/introduction-to-turbofan/)（关键文章！！！）
3. [Double-precision floating-point format](https://en.wikipedia.org/wiki/Double-precision_floating-point_format)（基础知识）
4. [Google CTF justintime exploit](https://eternalsakura13.com/2018/11/19/justintime/)（参考，没有仔细看）
5. [V8 Objects and Their Structures](https://pwnbykenny.com/2020/07/05/v8-objects-and-their-structures/)（基础知识）
6. [An Introduction to Speculative Optimization in V8](https://ponyfoo.com/articles/an-introduction-to-speculative-optimization-in-v8)（只看了前半部分，v8基础）
7. [Chrome V8文档](https://v8.dev/blog)（一些不了解的琐碎的知识点是在这里学习的）
8. [Exploiting the Math.expm1 typing bug in V8](https://abiondo.me/2019/01/02/exploiting-math-expm1-v8)（关键文章！！！）
9. [ArrayBuffer](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/ArrayBuffer)（关于ArrayBuffer的介绍）
10. [Exploiting v8: *CTF 2019 oob-v8](https://faraz.faith/2019-12-13-starctf-oob-v8-indepth/)（关键文章！！！个人觉得对于addrof和fakeobj介绍的很好）
...
2. [1. 环境搭建](https://bbs.kanxue.com/thread-270653.htm#msg_header_h1_1)
3. [2. 问题代码分析](https://bbs.kanxue.com/thread-270653.htm#msg_header_h1_2)
4. [3. 漏洞分析](https://bbs.kanxue.com/thread-270653.htm#msg_header_h1_3)
    1. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_0)
    2. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_1)
    3. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_2)
    4. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_3)
5. [4. 利用OOB W/R的方法](https://bbs.kanxue.com/thread-270653.htm#msg_header_h1_4)
    1. [4.1 前置知识](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_4)
        ...
        2. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_1)
    2. [4.2 利用方法分析](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_5)
    3. [4.3 更简单的OOB方式](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_6)
        1. [4.3.1 调试方法](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_2)
        2. [4.3.2 实验代码](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_3)
        3. [4.3.3 调试分析](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_4)
        4. [4.3.4 覆写长度属性](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_5)
    4. [4.4 获取对象地址的能力](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_7)
    5. [4.5 任意地址读写的能力](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_8)
    6. [4.6 利用WebAssembly获取可执行内存地址](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_9)
        1. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_6)
        2. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_7)
        3. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_8)
        4. [](https://bbs.kanxue.com/thread-270653.htm#msg_header_h3_9)
    7. [4.7 写入shellcode，触发！](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_10)
    8. [4.8 关于fakeobj和addrof](https://bbs.kanxue.com/thread-270653.htm#msg_header_h2_11)
6. [5. 总结](https://bbs.kanxue.com/thread-270653.htm#msg_header_h1_5)
7. [6. 参考资料](https://bbs.kanxue.com/thread-270653.htm#msg_header_h1_6)
