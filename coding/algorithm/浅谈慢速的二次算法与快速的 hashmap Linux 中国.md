...
1. `# 使用第一个命令行参数作为输入，运行程序`

1. `run(int(sys.argv[1]))`
...
1. `$ time python3 quadratic.py 100`

1. `[2]`

1. `real    0m0.053s`

1. `$ time python3 quadratic.py 1000`

1. `[2]`

1. `real    0m0.051s`

1. `$ time python3 quadratic.py 10000 # 10,000`
...
1. `$ time python3 linear.py 1000`

1. `[2]`

1. `real    0m0.036s`

1. `$ time python3 linear.py 10000 # 10,000`

1. `[2]`

1. `real    0m0.028s`

1. `$ time python3 linear.py 100000 # 100,000`

1. `[2]`

1. `real    0m0.048s <-- quadratic.py took 2 minutes in this case! we're doing it in 0.04 seconds now!!! so fast!`

1. `$ time python3 linear.py 1000000 # 1,000,000`

1. `[2]`

1. `real    0m0.178s`

1. `$ time python3 linear.py 10000000 # 10,000,000`
...
1. `File "/home/bork/work/homepage/linear.py", line 18, in <module>`

1. ```
   `run(int(sys.argv[1]))`
   ```

1. `File "/home/bork/work/homepage/linear.py", line 13, in run`
